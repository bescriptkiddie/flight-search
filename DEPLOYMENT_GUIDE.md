...
```bash
# 添加远程仓库
git remote add origin https://github.com/YOUR_USERNAME/airplane-search.git
...
- 几分钟后，您可以通过以下地址访问：
  `https://YOUR_USERNAME.github.io/airplane-search/`

## 📋 项目特性

✅ **自动部署**: 每次推送代码都会自动更新网站  
✅ **响应式设计**: 支持手机、平板、桌面设备  
✅ **实时数据**: 自动从在线API获取最新航班信息  
✅ **高级筛选**: 支持多条件筛选和排序  
✅ **全球CDN**: GitHub Pages 提供全球加速访问  
